    ...
    while True:
      try:
        ...
        if button.is_pressed:
            led.color = (1, 0, 0)
            print("timestamp:",  str(current_time()),"signal recording - start")
            recorded_data = record()
            print("timestamp:",  str(current_time()),"signal recording - end")          
            ...
            if sampled_data:
                ...
                if decoded_code != False:
                    ...
                    print("timestamp:", str(current_time()),"output:", decoded_code)
                else:
                    print("timestamp:", str(current_time()),"nie znaleziono kodu pilota" )
            else:
                print("timestamp:", str(current_time()),"nie znaleziono kodu pilota")
